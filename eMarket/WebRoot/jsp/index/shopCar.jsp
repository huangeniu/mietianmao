 ...
 <div class="title_box">用户登录</div>  
     <div class="border_box">
      <form>
      	...
      	<div style="padding:5px 0 0 0"><label for="loginPassword">登录密码：</label><input style="width:120px;" id="loginPassword"type="text"/></div>
     	<div style="padding:10px 0 5px 0"><input style=" background-color: #eee;"type="button" value="我要注册"/><input style=" background-color: #eee;float:right;margin-right:10px;"type="button" value="马上登录"/></div> 
      </form>
     </div>  
   		<div class="shopping_cart">
            ...
            <div class="cart_icon"><a href="#" title=""><img src="images/shoppingcart.png" alt="" title="" width="35" height="35" border="0" /></a>
            </div>
             <div class="cart_icon"><a href="#" title="退出登录"><img src="images/loginOut.png" style="margin:10px 0 0 15px;"alt="" title="" width="20" height="20" border="0" /></a>
            </div>
