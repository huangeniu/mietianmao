<%@ page language="java"
	import="java.util.*,com.mz2b.os.action.*,com.mz2b.os.vo.*"
	pageEncoding="utf-8"%>
<%
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script src="<%=request.getContextPath()%>/js/manage/bulletin/bulletininfo.js"></script>
			...
			<form name="callForm" method="post"
				...
				<div class="search_k">
					<fieldset class="seaech">
						...
						<div class="search_content">
							...
							<input type="text" id="summarization" name="user.summarization"
				...
				<div class="select">
					<span style="float: right;"> &nbsp;&nbsp; <input
							class="input_btn_style2" type="button" name="createData"
							value="&nbsp;新增&nbsp;" onclick="toCreateuser()" /> <input
							class="input_btn_style1" type="button" name="deleteData"
							value="&nbsp;删除&nbsp;" onclick="deletetemplate()" /> </span>
				</div>
				<div class="table_bg">
					<table width="98%" id="main_table" align="center">
						...
						<tr>
							<td align="center">
								<input type="checkbox" name="user.id" value="<%=to.getId()%>" />
							</td>

							<td align="center">
								<a href="#" onclick="viewuser('<%=to.getId()%>')"> <%=to.getPassword()%>
								</a>
							</td>
							...
							<td align="center">
								<a href="#" class="edit" onclick="toEdituser('<%=to.getId()%>')">修改</a>&nbsp;&nbsp;
								<a href="#" class="go" onclick="viewuser('<%=to.getId()%>')">查看操作</a>
							</td>
						</tr>
						<%
							}
